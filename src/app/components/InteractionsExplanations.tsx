...
const InteractionsExplanations = () => {
    return (
        <div className="absolute left-4 top-60 p-6 bg-transparent rounded-lg shadow-lg space-y-4">
            <h3 className="lg:text-xl md:text-xl sm:text-xs font-semibold text-gray-400">To interact with the model you have two choices:</h3>
            <p className="text-gray-400 lg:text-xl md:text-xl sm:text-xs">1. Use the keyboard:</p>
            <ul className="list-disc list-inside text-gray-400 space-y-2 lg:text-xl md:text-xl sm:text-xs">
                <li>
            ...
            <p className="text-gray-400 lg:text-xl md:text-xl sm:text-xs">
