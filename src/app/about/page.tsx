...
const About = () => {
    ...
    return (
        <div className="w-full min-h-screen flex flex-col bg-gray-50 p-4 lg:p-16">
            <Header />
            <div className="w-full flex flex-col lg:flex-row transition-all duration-500 ease-in-out lg:mb-20 md:mb-35 sm:mb-96">
                <div className="w-full lg:w-1/2 p-4 lg:p-8 flex flex-col justify-center">
                    ...
                    <p className="text-lg mb-6 text-gray-800">
                        ...
                        <a href="mailto:cbrzyski2@gmail.com" className="text-blue-500 hover:underline"> cbrzyski2@gmail.com</a>.
                    </p>
                </div>
            ...
            <div className="w-full flex flex-col lg:flex-row-reverse transition-all duration-500 ease-in-out lg:mb-20 md:mb-25 sm:mb-72 xs:mt-32">
                <div className="w-full lg:w-1/2 p-4 lg:p-8 flex flex-col justify-center">
            ...
            <div className="w-full flex flex-col lg:flex-row transition-all duration-500 ease-in-out lg:mb-20 md:mb-25 sm:mb-72">
                <div className="w-full lg:w-1/2 p-4 lg:p-8 flex flex-col justify-center">
            ...
            <div className="w-full flex flex-col lg:flex-row-reverse transition-all duration-500 ease-in-out lg:mb-20 md:mb-25 sm:mb-72">
                <div className="w-full lg:w-1/2 p-4 lg:p-8 flex flex-col justify-center">
